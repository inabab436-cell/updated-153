...
export const AGENT_PROMPT_SECTIONS: AgentPromptSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "When the customer picks or asks about a size, the reply carries one piece of meaning only: whether that exact line has stock, and if it does not, which sizes do. One short line, phrased freely. No photo offer, no description, no repetition of the price or the colour you already said.",
