...
export const AGENT_PROMPT_SECTIONS: AgentPromptSection[] = [
...

  {
    ...
    rules: [
      ...
      "Use that same call to know what to OFFER: list the colours and sizes it returns under in_stock, with their real quantities, and stay silent about everything under sold_out unless the customer named it. A variant you did not just read live is a variant you do not mention.",
